...
void detect_Up_XPips_On_BB_Plus2s() {
   ...
   Alert("inspect [",TimeToStr(TimeLocal(), TIME_DATE|TIME_SECONDS),"]");
      ...
      string subfolder = "Research\\31_1";      // subfolder name
      
      datetime t = TimeLocal();

      string fname = "P9A_ins_1.detect_BreakUp-BB-Plus-2s_" 
      ...
      string title = "Break up BB +2s: " + (string) X_UPS + " pips (inspect: p-9A)";
