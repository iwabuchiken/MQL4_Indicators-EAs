      ...
      if(filehandle!=INVALID_HANDLE)
        {
         ...
         //debug
         FileWrite(filehandle, "");
         FileWrite(filehandle, "[",__LINE__,"] 3-downs, then up...");
      ...
      if(filehandle!=INVALID_HANDLE)
        {
            ...
            for(int i = (numof_target_bars - 1); i >= 0; i--)
           {
               ...
               result = _inspect_P7A__exec__V2(i);
         ...
         //debug
         FileWrite(filehandle, "3 downs => detected");
...
int _inspect_P7A__exec__V2(int index) {
...
}//_inspect_P7A__exec__V2(int index)
