...
//input int      NUMOF_DAYS  = 800;    // Num of bars : local : 2016.05.05 07:00 ~ 2019.03.12 07:00
input int      NUMOF_DAYS  = 2000;    // Num of bars : local : 
//input int      NUMOF_DAYS  = 2500;    // Num of bars : n/w
//input int      NUMOF_DAYS  = 5000;    // Num of bars : local : 
//input int      NUMOF_DAYS  = 7000;    // Num of bars : local : 
//input int      NUMOF_DAYS  = 8000;    // Num of bars : local : n/w
