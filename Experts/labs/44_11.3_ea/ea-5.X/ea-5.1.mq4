...
//| vars                                               |
//+------------------------------------------------------------------+
extern string nameOf_Detect_Pattern = "dp_5.1";
//string PGName = "file=ea-4:dp=dp_2__All_True"

extern string PGName_File = "ea-5.1";

//extern string PGName = "file=ea-5.1:dp=" + nameOf_Detect_Pattern
string PGName = "file=" + PGName_File
            + ":dp=" + nameOf_Detect_Pattern
            + "\n"
               ...
               ********************************/
               /********************************
                  step : j3 : 0
                     conditions
               ********************************/
               //_20200515_120722:tmp
               int   id_dp_5_1 = 1;
               
               bool j3_b = dp_Dispatch(id_dp_5_1, dpath_Log , fname_Log_For_Session);
